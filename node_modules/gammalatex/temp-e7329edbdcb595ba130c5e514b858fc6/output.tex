...
{\centering
{\onehalfspacing
{\LARGE\bfseries {\color{blue}{{ Employee of the Week}}}}\
\vskip0.4em
{\calligra undefined} -- {\calligra \\}
\vskip0.4em
{\large This is to certify that the employees at large of\\}
{\Large\bfseries\color{blue}{Cassiopeia Industries \\}}
{\large have voted \uline{\MakeUppercase{Bob Ross}}}}\\
\par}
\end{minipage}
\hfill
%=============================
...
\vskip0.5em
{\large\bfseries \color{title}{ Employee of the Week }}\par
\vskip0.5em
